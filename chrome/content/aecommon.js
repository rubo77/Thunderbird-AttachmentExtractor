...
function AEPrefs() {
	...
	this.getComplex = function getComplex(pref,cci,branch) {
	...
	this.getFile = function getFile(pref,branch) {
		return this.getComplex(pref,Components.interfaces.nsILocalFile,branch);
	};
	this.getRelFile = function getRelFile(pref,branch) {
		return this.getComplex(pref,Components.interfaces.nsIRelativeFilePref,branch).file;
	};	
	this.getRelFileKey = function getRelFile(pref,branch) {
		return this.getComplex(pref,Components.interfaces.nsIRelativeFilePref,branch).relativeToKey;
	};	
	...
	this.setComplex = function setComplex(pref,cci,value,branch) {
	...
	this.setFile = function getFile(pref,value,branch) {
		return this.setComplex(pref,Components.interfaces.nsILocalFile,value,branch);
	}
	this.setRelFile = function setRelFile(pref,value,key,branch) {
		...
		var oldValue = (this.hasUserValue(pref,branch))?this.getComplex(pref,Components.interfaces.nsIRelativeFilePref,branch):null;
		relFile.relativeToKey = key ? key : oldValue.relativeToKey; 
		relFile.file = value ? value : oldValue.file;          
		return this.setComplex(pref,Components.interfaces.nsIRelativeFilePref,relFile,branch);
	};	
